...
Route::group(['prefix' => 'admin'], function () {
	...
	Route::group(['namespace' => 'Admin'], function () {
		...
		*/
			...
			Route::get('/pcategories', 'AdminCategoriesController@pcategories');
			Route::get('/paddcategory', 'AdminCategoriesController@paddcategory');
			Route::post('/paddnewcategory', 'AdminCategoriesController@paddnewcategory');
			Route::get('/peditcategory/{id}', 'AdminCategoriesController@peditcategory');
			Route::post('/pupdatecategory', 'AdminCategoriesController@pupdatecategory');
			Route::get('/pdeletecategory/{id}', 'AdminCategoriesController@pdeletecategory');

			//main categories
			Route::get('/categories', 'AdminCategoriesController@categories');
			Route::get('/listcategory/{id}', 'AdminCategoriesController@listcategory');
			...
			Route::get('/listsubcategory/{id}', 'AdminCategoriesController@listsubcategory');
