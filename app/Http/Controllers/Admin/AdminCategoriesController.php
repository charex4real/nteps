...
class AdminCategoriesController extends Controller
{
	...
	public function listcategory(Request $request){
		...
		->leftJoin('categories_description','categories_description.categories_id', '=', 'Category.categories_id')
		->leftJoin('categories as mainCategory','mainCategory.Categories_id', '=', 'Category.parent_id')
		->leftJoin('categories_description as mainCategoryDesc','mainCategoryDesc.categories_id', '=', 'Category.parent_id')
		->select('Category.categories_id as id', 'Category.categories_image as image',  'Category.categories_icon as icon',  'Category.date_added as date_added', 'Category.last_modified as last_modified','mainCategoryDesc.categories_name as mainCategoryName', 'categories_description.categories_name as name', 'categories_description.language_id')
		->where('Category.parent_id', $request->id)->where('categories_description.language_id', '1')->paginate(10);
		
		return view("admin.listcategories",$title)->with('categories', $categories);
		}
	}
	...
	public function categories(){
		...
		->leftJoin('categories_description as mainCategoryDesc','mainCategoryDesc.categories_id', '=', 'Category.parent_id')
		->select('Category.categories_id as id', 'Category.categories_image as image',  'Category.categories_icon as icon',  'Category.date_added as date_added', 'Category.last_modified as last_modified','mainCategoryDesc.categories_name as mainCategoryName', 'categories_description.categories_name as name', 'categories_description.language_id')
		->where('Category.group_id', '1')->where('categories_description.language_id', '1')->paginate(10);
	...
	public function pcategories(){
		...
		$title = array('pageTitle' => Lang::get("labels.ParentCategories"));
		...
		->where('group_id', '0')->where('categories_description.language_id', '1')->paginate(10);
		
		return view("admin.pcategories",$title)->with('categories', $categories);
		}
	}
	...
	public function addcategory(Request $request){
		...
		->where('group_id', '0')->where('language_id','=', 1)->get();
	...
	//add Parent  category
	public function paddcategory(Request $request){
		$title = array('pageTitle' => Lang::get("labels.PaddCategories"));
		...
		return view("admin.paddcategory",$title)->with('result', $result);
	}
	...
	//addNewCategory	
	public function paddnewcategory(Request $request){
		if(session('categories_create')==0){
			print Lang::get("labels.You do not have to access this route");
		}else{
		...
		$message = Lang::get("labels.ParentCategoriesAddedMessage");
	...
	public function editcategory(Request $request){		
		...
		->select('categories.categories_id as id','categories.parent_id as pent_id', 'categories.categories_image as image', 'categories.categories_icon as icon',  'categories.date_added as date_added', 'categories.last_modified as last_modified', 'categories.categories_slug as slug')
	...
	//Parent  editCategory
	public function peditcategory(Request $request){		
		$title = array('pageTitle' => Lang::get("labels.EditParentCategories"));
		$result = array();		
		$result['message'] = array();
		...
		return view("admin.peditcategory", $title)->with('result', $result);
	}
	...
	public function pupdatecategory(Request $request){		
		if(session('categories_update')==0){
			print Lang::get("labels.You do not have to access this route");
		}else{
	...
	//delete category
	public function pdeletecategory(Request $request){
		if(session('categories_delete')==0){
			print Lang::get("labels.You do not have to access this route");
		}else{
		...
		//delete sub-category products/categories
		$categories = DB::table('categories')->where('parent_id', $request->id)->get();
			foreach($categories as $category){

				DB::table('categories_description')->where('categories_id', $category->id)->delete();
			...
			->leftjoin('flash_sale','inventory_detail.products_id','=','products.products_id')
			->leftjoin('products_images','products_images.products_id','=','products.products_id')
			->where('categories_id', $category->id)->delete();
	...
	public function listsubcategory(Request $request){
		...
		->select(
			...
			)->where('subCategories.group_id', '2')
		->where('subCategories.parent_id',  $request->id)->where('subCategoryDesc.language_id', '1')->where('mainCategoryDesc.language_id', '1')->orderBy('subId','ASC')->paginate(20);
		
		return view("admin.listsubcategories",$title)->with('listingSubCategories', $listingSubCategories);
		}
	}
	...
	public function addsubcategory(Request $request){		
		...
		->leftJoin('categories_description','categories_description.categories_id', '=', 'categories.categories_id')
		->select('categories.categories_id as mainId', 'categories_description.categories_name as mainName')
		->where('group_id', '1')->where('language_id','=', 1)->get();
		$result['categories'] = $categories;
