...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>{{ trans('labels.EditParentCategories') }}  <small>{{ trans('labels.EditParentCategories') }}...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/listingCategories')}}"><i class="fa fa-bars"></i> {{ trans('labels.ListAllCategories') }}</a></li>
      <li class="active">{{ trans('labels.EditParentCategories') }}</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">{{ trans('labels.EditParentCategories') }} </h3>
          </div>
                    ...
                    <br>                       
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/pupdatecategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
