                   ...
                   @if(count($listingSubCategories)>0)
                    ...
                    @if($categories->language_id == '1')
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ URL::to('admin/editsubcategory/')}}/{{ $categories->subId }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                <a data-toggle="tooltip" data-placement="bottom" title="Delete" href="{{ URL::to('admin/deletesubcategory/')}}/{{ $categories->subId }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @endif
                    @endforeach
