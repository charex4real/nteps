                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updatecategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div class="form-group">
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.ParentCategory') }}</label>
                                  <div class="col-sm-10 col-md-4">
                                      <select class="form-control" name="parent_id">
                                         @foreach ($result['categories'] as $categories)
                                          ...
                                          @if($categories->mainId == $result['editCategory'][0]->pent_id)
                                      ...
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.ChooseParentCategory') }}</span>
