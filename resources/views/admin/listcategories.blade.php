                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>{{ trans('labels.ParentCategory') }}</th>
                  ...
                  @if(count($categories)>0)
                    @foreach ($categories as $key=>$category)
                        <tr>
                            <td>{{ $category->id }}</td>
                            <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.ListAllCategories') }}" href="
                              {{ URL::to('admin/listsubcategory/')}}/{{ $category->id }}" class="badge bg-light-blue">
                              {{ $category->name }}</a> </td>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ URL::to('admin/editcategory/')}}/{{ $category->id }}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                            <a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Delete') }}" href="{{ URL::to('admin/deletecategory/')}}/{{ $category->id }}" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
