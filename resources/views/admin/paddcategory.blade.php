...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> {{ trans('labels.ParentCategories') }} <small>{{ trans('labels.ParentCategories') }}...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="{{ URL::to('admin/dashboard/this_month') }}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li><a href="{{ URL::to('admin/listingCategories')}}"><i class="fa fa-bars"></i> {{ trans('labels.ListingAllParentCategories') }}</a></li>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">{{ trans('labels.ParentCategories') }} </h3>
          </div>
              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/paddnewcategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/pcategories')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
