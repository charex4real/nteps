<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('admin/categories') ? 'active' : '' }} {{ Request::is('admin/addcategory') ? 'active' : '' }} {{ Request::is('admin/editCategory/*') ? 'active' : '' }}
        { Request::is('admin/pcategories') ? 'active' : '' }} {{ Request::is('admin/paddcategory') ? 'active' : '' }} {{ Request::is('admin/peditCategory/*') ? 'active' : '' }}
         {{ Request::is('admin/subcategories') ? 'active' : '' }}  {{ Request::is('admin/addsubcategory') ? 'active' : '' }}  {{ Request::is('admin/editsubcategory/*') ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-bars" aria-hidden="true"></i>
<span>{{ trans('labels.link_categories') }} </span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          	<li class="{{ Request::is('admin/pcategories') ? 'active' : '' }} {{ Request::is('admin/paddcategory') ? 'active' : '' }} {{ Request::is('admin/peditcategory/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/pcategories')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_parent_categories') }}</a></li>
