...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> <?php echo e(trans('labels.ParentCategories')); ?> <small><?php echo e(trans('labels.ParentCategories')); ?>...</small> </h1>
    <ol class="breadcrumb">
       <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
      <li><a href="<?php echo e(URL::to('admin/listingCategories')); ?>"><i class="fa fa-bars"></i> <?php echo e(trans('labels.ListingAllParentCategories')); ?></a></li>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.ParentCategories')); ?> </h3>
          </div>
              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/paddnewcategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="<?php echo e(URL::to('admin/pcategories')); ?>" type="button" class="btn btn-default"><?php echo e(trans('labels.back')); ?></a>
                              </div>
                              <!-- /.box-footer -->
                            <?php echo Form::close(); ?>
