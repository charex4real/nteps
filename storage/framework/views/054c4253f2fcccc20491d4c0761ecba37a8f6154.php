                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo e(trans('labels.ParentCategory')); ?></th>
                  ...
                  <?php if(count($categories)>0): ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.ListAllCategories')); ?>" href="
                              <?php echo e(URL::to('admin/listsubcategory/')); ?>/<?php echo e($category->id); ?>" class="badge bg-light-blue">
                            ...
                            <td><strong><?php echo e($category->mainCategoryName); ?></strong></td>
                            ...
                            <td><a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Edit')); ?>" href="<?php echo e(URL::to('admin/editcategory/')); ?>/<?php echo e($category->id); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                            <a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Delete')); ?>" href="<?php echo e(URL::to('admin/deletecategory/')); ?>/<?php echo e($category->id); ?>" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
