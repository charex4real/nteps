<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo e(Request::is('admin/categories') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addcategory') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editCategory/*') ? 'active' : ''); ?>

        { Request::is('admin/pcategories') ? 'active' : '' }} <?php echo e(Request::is('admin/paddcategory') ? 'active' : ''); ?> <?php echo e(Request::is('admin/peditCategory/*') ? 'active' : ''); ?>

         <?php echo e(Request::is('admin/subcategories') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/addsubcategory') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/editsubcategory/*') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-bars" aria-hidden="true"></i>
<span><?php echo e(trans('labels.link_categories')); ?> </span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
          	<li class="<?php echo e(Request::is('admin/pcategories') ? 'active' : ''); ?> <?php echo e(Request::is('admin/paddcategory') ? 'active' : ''); ?> <?php echo e(Request::is('admin/peditcategory/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/pcategories')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.link_parent_categories')); ?></a></li>
