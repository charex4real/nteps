                                    ...
                                    <form name="attributes" id="add-Product-form" method="post" >
                                        ...
                                        <div class="form-inline product-box">
                                            ...
                                            <div class="price-box">
                                                ...
                                                <?php if(!empty($result['detail']['product_data'][0]->flash_price)): ?>
                                                	<?php echo e($web_setting[19]->value); ?><?php echo e($result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->flash_price+0); ?>                                                <?php elseif(!empty($result['detail']['product_data'][0]->discount_price)): ?>
                                                	<?php echo e($web_setting[19]->value); ?><?php echo e($result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->discount_price+0); ?>

                                                <?php else: ?>
                                                	<?php echo e($web_setting[19]->value); ?><?php echo e($result['detail']['product_data'][0]->products_min_order*$result['detail']['product_data'][0]->products_price+0); ?>
