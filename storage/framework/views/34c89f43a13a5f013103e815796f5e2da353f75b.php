                   ...
                   <?php if(count($listingSubCategories)>0): ?>
                    ...
                    <?php if($categories->language_id == '1'): ?>
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="<?php echo e(URL::to('admin/editsubcategory/')); ?>/<?php echo e($categories->subId); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                <a data-toggle="tooltip" data-placement="bottom" title="Delete" href="<?php echo e(URL::to('admin/deletesubcategory/')); ?>/<?php echo e($categories->subId); ?>" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        <?php endif; ?>
