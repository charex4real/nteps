...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1><?php echo e(trans('labels.EditParentCategories')); ?>  <small><?php echo e(trans('labels.EditParentCategories')); ?>...</small> </h1>
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(trans('labels.EditParentCategories')); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.EditParentCategories')); ?> </h3>
          </div>
                    ...
                    <br>                       
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/pupdatecategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
